            ...
            <div class="widget induscity-office-location-widget">
                <div class="office-location clearfix">
                    <div class="office-switcher">
                        ...
                        <a class="current-office" href="#">Enugu</a>
                        <ul>
                            <li class="location active" data-tab="cargohub-office-1">Enugu</li>
                    ...
                    <ul id="cargohub-office-1" class="office-1 topbar-office active">
                        <li class="time"><i class="flaticon-arrow"></i>Plot Nō 2, within 4 corners, Enugu</li>
                        <li class="phone"><i class="flaticon-tool"></i>Call Us: +(234) 903 334 1839</li>
        ...
        <div class="topbar-right topbar-widgets text-right clearfix">
            <div class="widget induscity-languages-widget">
                <div class="language list-dropdown">
                    <marquee>
                    <span style="color: #f7c02d !important">Current Price: <b>₦<?= number_format($current_price); ?></b> </span>
                  </marquee>
                </div>
            </div>
